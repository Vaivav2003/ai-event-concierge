  ...
  if (!history?.length) {
    return (
      <div style={{ textAlign: "center", padding: "32px 16px" }}>
        ...
        <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.25)" }}>No searches yet</p>
      </div>
    );
  }
      ...
      {history.map((item) => (
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", gap: "8px" }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontSize: "13px", fontWeight: 500, color: "rgba(255,255,255,0.8)", marginBottom: "3px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {item.venue_name}
              </p>
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                📍 {item.location}
              </p>
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.2)", fontStyle: "italic", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", marginTop: "3px" }}>
                "{item.user_query}"
              </p>
            </div>
            <p style={{ fontSize: "13px", fontWeight: 600, color: "#63b3ed", flexShrink: 0 }}>
              {fmt(item.estimated_cost_usd)}
            </p>
          </div>
        </button>
      ))}
